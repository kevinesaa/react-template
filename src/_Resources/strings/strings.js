...
const Strings = Object.freeze({
    ...
    text_operation_general_error:"Lo lamentamos, ha ocurrido un error, por favor vuelva a intentar",
    ...
    documents_details_status_title:"Estatus",
    documents_details_date_conciliated:"Fecha Conciliación",
    ...
    change_pass_error_not_valid_current_pass:"La contraseña actual ingresada no es válida",
